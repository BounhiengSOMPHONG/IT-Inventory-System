                    ...
                    <form method="POST" action="{{ route('products.update', $product->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="ProductName" class="block mt-1 w-full" type="text" name="ProductName" :value="old('ProductName', $product->ProductName)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="ProductModel" class="block mt-1 w-full" type="text" name="ProductModel" :value="old('ProductModel', $product->ProductModel)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="Manufacturer" class="block mt-1 w-full" type="text" name="Manufacturer" :value="old('Manufacturer', $product->Manufacturer)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="AssetCode" class="block mt-1 w-full" type="text" name="AssetCode" :value="old('AssetCode', $product->AssetCode)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="SerialNumber" class="block mt-1 w-full" type="text" name="SerialNumber" :value="old('SerialNumber', $product->SerialNumber)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="ServiceTag" class="block mt-1 w-full" type="text" name="ServiceTag" :value="old('ServiceTag', $product->ServiceTag)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="Status" class="block mt-1 w-full" type="text" name="Status" :value="old('Status', $product->Status)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="HD" class="block mt-1 w-full" type="text" name="HD" :value="old('HD', $product->HD)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="RAM" class="block mt-1 w-full" type="text" name="RAM" :value="old('RAM', $product->RAM)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="CPU" class="block mt-1 w-full" type="text" name="CPU" :value="old('CPU', $product->CPU)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="YearBought" class="block mt-1 w-full" type="number" name="YearBought" :value="old('YearBought', $product->YearBought)" required />
